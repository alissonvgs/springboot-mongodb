...
import com.alissonvgs.workshopmongo.dto.UserDTO;
...
public class UserService {
	...
	public User findById(String id) {
		...
		return user.orElseThrow(() -> new ObjectNotFoundException("Objeto não encontrado! Id: " + id + ", Tipo: " + User.class.getName()));
	}
